...
export const ContactsFiltersComponent = memo(
  ({ filters, onChange, tags, meetingPlaces }: ContactsFiltersProps) => {
    ...
    const handleMeetingPlacesChange = (meetingPlaceIds: string[]) => {
      onChange({
        ...filters,
        meetingPlaceIds: meetingPlaceIds.length ? meetingPlaceIds : undefined,
      });
    };
